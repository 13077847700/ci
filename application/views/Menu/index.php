...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content" style="margin-top:70px;">
            ...
            <form id="menu-form" class="form-horizontal form-data" action="<?php echo site_url('admin/Menu/add_or_update') ?>" method="post">
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" id="title" name="title" class="form-control" placeholder="请输入菜单名" value='' />
						</div>
					</div>
...
<script>
	$(document).ready(function(){
		...
		$('.btn-add').click(function(){
			...
			url = "<?php echo site_url('admin/Menu/add') ?>";
			$.ajax({
				url : url,
				type : "POST",
				data : 
		...
		$('.btn-edit').click(function(){
			...
			url = "<?php echo site_url('admin/Menu/edit') ?>";
		...
		$('.btn-del').click(function(){
			...
			url = "<?php echo site_url('admin/Menu/del') ?>"
					...
					success : function(data)
					{
						...
						{							
							me.parents('tr').fadeOut("slow", function(){
								...
								window.location.href = "<?php echo site_url('admin/Menu/index') ?>";
							})
